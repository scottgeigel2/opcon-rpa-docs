...
title: VisualCron RPA system requirements
description: "Operating system, CPU, memory, and disk requirements for VisualCron RPA Server, Client, and combined Client/Server installations."
tags:
  - Reference
...
This page lists the operating system, processor, memory, and disk requirements for installing VisualCron RPA. Requirements differ depending on whether you are installing the Server, the Client, or both on the same machine.
...
- VisualCron requires .NET Framework 4.8
